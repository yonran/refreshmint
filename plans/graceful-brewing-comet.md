...
Status: complete in `main`, across commits `9fde2bd` through `5bfb23d`.
...
- Scraping UI now normalizes login configs so missing/null `accounts` do not crash login loading.
